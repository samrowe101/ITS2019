---
title: "Randomized Equivalence Study Evaluating the Efficacy of Two Commercial Internal Teat Sealants in Dairy Cows: quarter-level outcomes"
...
```{r}
Desc1 <- lockqtr %>% select(FARMID,Cow,QTR,Tx,Age,Parity,IMIDO,SCCDO,MYDO,DIMDO,CM1,PeakSCC,DPlength,PCSampDIM,IMIPC,Cure,NewIMI)
head(Desc1, n=10)
```
...
```{r}
print(summarytools::dfSummary(Desc1, valid.col=FALSE, graph.magnif=0.8, style="grid"), method = "render")
```
<br>
<br>
