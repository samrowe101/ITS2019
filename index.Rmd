...
<br>
Download dataset for [Quarter-level outcomes](https://www.google.com)
...
head(Desc1, n=10) %>% kable()
#write.csv(lockqtr,"ITS2019IMI.csv")
```
...
print(summarytools::dfSummary(Desc1, valid.col=FALSE,graph.magnif=0.5,varnumbers=F,style="grid"))
