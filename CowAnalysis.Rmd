...
print(summarytools::dfSummary(lockcow,valid.col=FALSE, graph.magnif=0.8, style="grid"))
```
<br>
<br>
...
print(summarytools::dfSummary(lockcowdhi,valid.col=FALSE,graph.magnif=0.5,varnumbers=F, style="grid"))
